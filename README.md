...
Nesse projeto, foi praticada as hablilidades:

- Manter aderência do código à especificação. Seu programa deve se comportar como especificado no repositório;
...
Nessa aplicação, foi desenvolvidos tanto o back-end quanto o front-end de uma aplicação de delivery.
...
```bash
  git clone git@github.com:leo606/delivery-app-trybe.git
```

Entre no diretório do projeto

```bash
  cd delivery-app-trybe
```
...
Inicie os conteiners docker:

```bash
  sudo docker-compose up
```

  Após o docker criar as imagens e rodar os containers, será exposto um servidor na porta 8080, acesse a aplicação pelo endereço `localhost:8080`
